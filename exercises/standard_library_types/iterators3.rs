...
pub fn divide(a: i32, b: i32) -> Result<i32, DivisionError> {
    if b == 0 { Err(DivisionError::DivideByZero) }
        ...
        let y = a % b;
        if y == 0 { Ok(a / b) } else { Err(DivisionError::NotDivisible(NotDivisibleError { dividend: a, divisor: b })) }
    }
}
...
mod tests {
    ...
    fn result_with_list() {
        ...
        // doc/rust/html/std/iter/trait.Iterator.html#method.collect
